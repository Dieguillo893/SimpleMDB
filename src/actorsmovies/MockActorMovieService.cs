...
public class MockActorMovieService : ActorMovieService
{
    private ActorMovieRepository actorMovieRepository;

    public MockActorMovieService(ActorMovieRepository actorMovieRepository)
    {
    ...
    public async Task<Result<PagedResult<(ActorMovie, Movie)>>> ReadAllMoviesByActor(int actorId, int page, int size)
    {
        ...
        var result = (pagedResult == null) ?
            new Result<PagedResult<(ActorMovie, Movie)>>(new Exception("No movies by actor Result found.")) :
    ...
    public async Task<Result<PagedResult<(ActorMovie, Actor)>>> ReadAllActorsByMovie(int movieId, int page, int size)
    {
        ...
        var result = (pagedResult == null) ?
        new Result<PagedResult<(ActorMovie, Actor)>>(new Exception("No actors by movies Result found.")) :
    ...
    public async Task<Result<List<Actor>>> ReadAllActors()
    {
        ...
        var result = (pagedResult == null) ?
        new Result<List<Actor>>(new Exception("No actors Result found.")) :
    ...
    public async Task<Result<List<Movie>>> ReadAllMovies()
    {
        ...
        var result = (pagedResult == null) ?
        new Result<List<Movie>>(new Exception("No movies Result found.")) :
    ...
    public async Task<Result<ActorMovie>> Delete(int id)
    {
        ...
        var result = (actorMovie == null) ?
        new Result<ActorMovie>(new Exception("ActorMovie could be not deleted.")) :
        new Result<ActorMovie>(actorMovie!);
